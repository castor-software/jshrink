...
public class Application {
	...
	public static void main(String[] args) {
		...
		try {
			...
			if(commandLineParser.isVerbose()){
				System.out.println("[" + new java.util.Date() + "]" + "Creating jShrink instance...");
			}
			...
			if(commandLineParser.isVerbose()){
				System.out.println("[" + new java.util.Date() + "]" + "Done creating jShrink instance!");
				System.out.println("[" + new java.util.Date() + "]" + "Making \"soot pass\"...");
			}
			...
			if(commandLineParser.isVerbose()){
				System.out.println("[" + new java.util.Date() + "]" + "Done making \"soot pass\"! in " + analysisEndTime + "ns");
			}
			...
			if(!commandLineParser.isSkipMethodRemoval()) {
				if(commandLineParser.isVerbose()){
					System.out.println("[" + new java.util.Date() + "]" + "Removing unused methods...");
				}
				...
				if(commandLineParser.isVerbose()){
					System.out.println("[" + new java.util.Date() + "]" + "Done removing unused methods!");
				}
				...
				if(commandLineParser.removedFields()) {
					if(commandLineParser.isVerbose()){
						System.out.println("[" + new java.util.Date() + "]" + "Removing unused fields...");
					...
					if(commandLineParser.isVerbose()){
						System.out.println("[" + new java.util.Date() + "]" + "Done removing unused fields!");
					}
				...
				if (commandLineParser.collapseClasses()) {
					if(commandLineParser.isVerbose()){
						System.out.println("[" + new java.util.Date() + "]" + "Collapsing collapsable classes...");
						libClassesBeforeRemoved = libClassesRemoved;
						appMethodsBeforeRemoved = appMethodsRemoved;
						libMethodsBeforeRemoved = libMethodsRemoved;
						appClassesBeforeRemoved = appClassesRemoved;
					...
					removedClasses.addAll(jShrink.classesToRemove());
					if(commandLineParser.isVerbose()){
						System.out.println("[" + new java.util.Date() + "]" + "Done collapsing collapsable classes!");
					}
	...
	//			jShrink.updateClassFiles();
			...
			if (commandLineParser.inlineMethods()) {
				if(commandLineParser.isVerbose()){
					System.out.println("[" + new java.util.Date() + "]" + "Inlining inlinable methods...");
					libClassesBeforeRemoved = libClassesRemoved;
					appMethodsBeforeRemoved = appMethodsRemoved;
					libMethodsBeforeRemoved = libMethodsRemoved;
					appClassesBeforeRemoved = appClassesRemoved;
				...
				removedClasses.addAll(jShrink.classesToRemove());
				if(commandLineParser.isVerbose()){
					System.out.println("[" + new java.util.Date() + "]" + "Done inlining inlinable methods!");
				}
			...
			outputToLogDirectory(
				commandLineParser.getLogDirectory(), 
				toLog.toString(), 
				toLogVerbose.toString(),
					commandLineParser.isRunTests() ? Optional.of((testOutputBefore != null)?testOutputBefore.getTestOutputText():"") : Optional.empty(),
					commandLineParser.isRunTests() ? Optional.of((testOutputAfter != null)?testOutputAfter.getTestOutputText():"") : Optional.empty(),
					unmodifiableClass);

			if(commandLineParser.isVerbose()){
				System.out.println("[" + new java.util.Date() + "]" + "Output logging info to \"" + commandLineParser.getLogDirectory() + "\".");
			}
		}
	}
